...
# Antes y después de modificar los métodos anteriores estas lineas deben de imprimir "true"
 dummy_encrypt("EsteEsMiPassword") == "DROWSSApImS*ETS*"

p result1 = words_longer_than("entero entrar envase enviar enzima equino equipo erario erguir eriaza eriazo erigir eringe eficientemente electroencefalografía",3)

p result2 = letter_per_word(result1,"e")

p result3 = numbers_larger_than(result2)

p max_letter_frequency_per_word(result3) == 5 
